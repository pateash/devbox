...
const api: DevBoxApi = {
  ...
  jira: { connect: (input) => ipcRenderer.invoke('jira:connect', input), get: (workspaceId) => ipcRenderer.invoke('jira:get', workspaceId), setProjects: (workspaceId, projects) => ipcRenderer.invoke('jira:setProjects', workspaceId, projects), refresh: (workspaceId) => ipcRenderer.invoke('jira:refresh', workspaceId), disconnect: (workspaceId) => ipcRenderer.invoke('jira:disconnect', workspaceId), workItems: (workspaceId) => ipcRenderer.invoke('jira:workItems', workspaceId) },
