...
function App(): React.ReactElement {
  ...
  const title = useMemo(() => page === 'GitHub' ? 'Git' : page === 'Jira' ? 'Kanban' : page === 'Bitbucket' ? 'Git' : page === 'GlobalSettings' ? 'Global settings' : page === 'GlobalIntegrations' ? 'Global integrations' : page, [page])
